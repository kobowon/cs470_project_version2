...
train2014_path = '/notebooks/project_cs470/cs470_tp/data/coco_2014/train2014'
val2014_path = '/notebooks/project_cs470/cs470_tp/data/coco_2014/val2014'
...
if __name__ == '__main__':
    ...
    if os.path.exists(train_ids_file) and os.path.exists(val_ids_file):
        ...
        train_imgids = feature_utils.load_imageid(train2014_path)
        val_imgids = feature_utils.load_imageid(val2014_path)
